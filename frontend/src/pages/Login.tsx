...
const Login: React.FC = () => { // Remover props
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://gl-garantias-backend.onrender.com'}/api/v1/auth/check-first-login`, {
        method: 'POST',
        headers: {
  ...
  const handlePasswordSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://gl-garantias-backend.onrender.com'}/api/v1/auth/login`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleFirstPasswordSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://gl-garantias-backend.onrender.com'}/api/v1/auth/set-first-password`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
