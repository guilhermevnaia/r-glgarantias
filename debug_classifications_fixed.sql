-- =====================================================
-- DEBUG: Investigar problema das classificações (CORRIGIDO)
-- =====================================================
...
-- 6. Tentar inserir uma classificação de teste (CORRIGIDO)
INSERT INTO defect_classifications (
    ...
    ARRAY[]::integer[],  -- CORRIGIDO: usar array de integers
    false
);
